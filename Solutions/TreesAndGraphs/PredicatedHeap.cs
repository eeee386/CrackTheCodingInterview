...
namespace Solutions.TreesAndGraphs
{
    ...
    public class PredicatedHeap
    {
            ...
            if (parentIndexOfNewElement != -1)
            {
                ...
                while (indexOfNewElement != 0)
                {
                    if (Predicate(newElement, parentOfNewElement))
                    {
                        ...
                        indexOfNewElement = parentIndexOfNewElement;
        ...
        public int Remove()
        {
            ...
            while (firstChild != null && (Predicate((int) firstChild, parent) ||
                                          (secondChild != null && Predicate((int) secondChild, parent))))
            {
